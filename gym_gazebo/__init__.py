...
#Custom
register(
    id='GazeboTurtlebotAroundCamera-v1',
    entry_point='gym_gazebo.envs.custom:GazeboTurtlebotAroundCameraEnv',
)

register(
    id='GazeboTurtlebotInHouse-v0',
    entry_point='gym_gazebo.envs.custom:GazeboTurtlebotInHouseV0Env',
)

register(
    id='GazeboTurtlebotMazeTarget-v0',
    entry_point='gym_gazebo.envs.custom:GazeboTurtlebotMazeTargetEnv',
)
register(
    id='GazeboTurtlebotMazeColor-v0',
    entry_point='gym_gazebo.envs.custom:GazeboTurtlebotMazeColorEnv',
)
register(
    id='GazeboTurtlebotComplicatedMaze-v0',
    entry_point='gym_gazebo.envs.custom:GazeboTurtlebotComplicatedMazeEnv',
)