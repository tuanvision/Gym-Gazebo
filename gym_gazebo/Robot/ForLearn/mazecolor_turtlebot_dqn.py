...
if __name__ == '__main__':
    ...
    weights_path = '/home/tuanguyen/Desktop/turtle_mazecolor_dqn.h5'
    params_json  = '/home/tuanguyen/Desktop/turtle_mazecolor_dqn.json'
    ...
    for epoch in xrange(current_epoch+1, epochs+1, 1):
        ...
        for t in xrange(steps):
            ...
            if done:
                ...
                if (epoch)%20==0:
                    print ("Saving model ...")	
                    deepQ.saveModel('/home/tuanguyen/Desktop/turtle_mazecolor_dqn'+'.h5')
                    ...
                    with open('/home/tuanguyen/Desktop/turtle_mazecolor_dqn'+'.json', 'w') as outfile:
