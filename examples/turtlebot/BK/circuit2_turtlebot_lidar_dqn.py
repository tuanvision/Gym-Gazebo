...
if __name__ == '__main__':
    ...
    weights_path = '/home/lntk/Desktop/turtle_c2_dqn.h5'
    # monitor_path = '/tmp/turtle_c2_dqn_ep200'
    params_json  = '/home/lntk/Desktop/turtle_c2_dqn.json'
    ...
    for epoch in xrange(current_epoch+1, epochs+1, 1):
        ...
        for t in xrange(steps):
            ...
            # rewardCalculated = calculateReward(observation, action)
            newObservation, reward, done, info = env.step(action)
            # if not done:
            #     reward = round(rewardCalculated, 2)
            ...
            if done:
                ...
                if (epoch)%20==0:
                    print ("Saving model ...")	
                    deepQ.saveModel('/home/lntk/Desktop/turtle_c2_dqn'+'.h5')
                    ...
                    with open('/home/lntk/Desktop/turtle_c2_dqn'+'.json', 'w') as outfile:
