...
def readFile():
    with open("/home/lntk/test.txt", "r") as myfile:
        for line in myfile:
            return line
...
if __name__ == '__main__':
    ...
    weights_path = '/home/thangbm/gym-gazebo/examples/turtlebot/model/turtle_c2_dqn_lidar.h5'
    # monitor_path = '/tmp/turtle_c2_dqn_ep200'
    params_json  = '/home/thangbm/gym-gazebo/examples/turtlebot/model/b_turtle_c2_dqn.json'
    ...
    for epoch in xrange(current_epoch+1, epochs+1, 1):
        ...
        moving_count_2 = 0
        moving_speed_2 = 0.4
        writeFile(moving_speed_1, "/home/lntk/moving_box_1.txt")
        writeFile(moving_speed_2, "/home/lntk/moving_box_2.txt")        
        cumulated_reward = 0

        # number of timesteps
        for t in xrange(steps):
            # count for moving box
            if moving_count_1 > moving_total_1:
                moving_count_1 = 0
                moving_speed_1 = -moving_speed_1
                writeFile(moving_speed_1, "/home/lntk/moving_box_1.txt")
            moving_count_1 += 1

            if moving_count_2 > moving_total_2:
                moving_count_2 = 0
                moving_speed_2 = -moving_speed_2
                writeFile(moving_speed_2, "/home/lntk/moving_box_2.txt")
            moving_count_2 += 1
            ...
            if done:
                ...
                if True:
                    ...
                    if (epoch)%10==0:
                        ...
                        deepQ.saveModel('/home/thangbm/gym-gazebo/examples/turtlebot/model/turtle_c2_dqn_lidar.h5')
                        # env.monitor.flush()
                        ...
                        # with open('/home/thangbm/gym-gazebo/examples/turtlebot/model/turtle_c2_dqn.json', 'w') as outfile:
        ...
        explorationRate *= 0.988 #epsilon decay
