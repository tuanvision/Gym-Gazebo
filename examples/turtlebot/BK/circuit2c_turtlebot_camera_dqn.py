...
class DeepQ:
    ...
    def createModel(self):
        ...
        model = Sequential()
        model.add(Convolution2D(16, 3, subsample=(2,2), input_shape=(img_channels,img_rows,img_cols)))
        model.add(Activation('relu'))
        model.add(ZeroPadding2D((1, 1)))
        model.add(Convolution2D(16, 3, subsample=(2,2)))
        model.add(Activation('relu'))
...
if __name__ == '__main__':
    ...
    weights_path = '/home/lntk/Desktop/turtle_c2c_dqn.h5' 
    # monitor_path = '/tmp/turtle_c2c_dqn_ep200'
    params_json  = '/home/lntk/Desktop/turtle_c2c_dqn.json'
    ...
    for epoch in xrange(current_epoch+1, epochs+1, 1):
        ...
        for t in xrange(steps):
            ...
            if done:
                ...
                # if last100RewardsIndex >= 100: # fixed here
                #    last100Filled = True
                #    last100RewardsIndex = 0
                ...
                if not last100Filled:
                    ...
                    if (epoch)%50==0: # fixed here
			print ("Saving model ...")
                        #save model weights and monitoring data every 100 epochs. 
                        deepQ.saveModel('/home/lntk/Desktop/turtle_c2c_dqn' + '.h5')
                        # env.monitor.flush()
                        # copy_tree(outdir,'/home/lntk/Desktop/turtle_c2c_dqn_ep'+str(epoch))
                        ...
                        with open('/home/lntk/Desktop/turtle_c2c_dqn'+'.json', 'w') as outfile:
