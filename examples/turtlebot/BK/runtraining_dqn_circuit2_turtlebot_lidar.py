...
class DeepQ:
    ...
    def getQValues(self, state):
        predicted = self.model.predict(state.reshape(1,state.shape[0]))
        return predicted[0]
...
if __name__ == '__main__':
    ...
    weights_path = '/home/tuanguyen/Desktop/model/train/h5.h5'
    params_json  = '/home/tuanguyen/Desktop/model/train/json.json'
